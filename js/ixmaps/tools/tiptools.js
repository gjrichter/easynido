...
TipTool.prototype.zoomIcon = function() {
	if ( !this.marker.__zoomed ){
		...
		if ( icon && icon.size ){
			...
			// set zindex
			this.marker.__zoomed = this.marker.getZIndex();
			this.marker.__zoomed = (typeof(this.marker.__zoomed) != "undefined")?this.marker.__zoomed:0;
...
TipTool.prototype.unzoomIcon = function() {
	if ( this.marker.__zoomed != null ){
		...
		if ( icon && icon.size ){
			...
			this.marker.setIcon(icon);
			this.marker.setZIndex(this.__zoomed);
